...
<link href="https://fonts.googleapis.com/css2?family=Marcellus&family=Noto+Sans:ital,wght@0,100..900;1,100..900&family=Shippori+Mincho:wght@400;500;700&display=swap" rel="stylesheet">
...
<?php
	...
	if ( SWELL_Theme::is_use( 'mv' ) ) {
		// $cache_key = $SETTING['cache_top'] ? 'mv_child' : '';
