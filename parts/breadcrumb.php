	...
	if ( $data['url'] ) {
		...
		$list_html .= '<li class="p-breadcrumb__item">' .
			'<a href="' . esc_url( $data['url'] ) . '" class="p-breadcrumb__text">' .
				'<span>' . esc_html( wp_strip_all_tags( str_replace( array('[spbr]', '[br]'), '', $data['name'] ) ) ) . '</span>' .
			'</a>' .
		'</li>';
		...
		$list_html .= '<li class="p-breadcrumb__item">' .
			'<span class="p-breadcrumb__text">' . esc_html( wp_strip_all_tags( str_replace( array('[spbr]', '[br]'), '', $data['name'] ) ) ) . '</span>' .
		'</li>';
